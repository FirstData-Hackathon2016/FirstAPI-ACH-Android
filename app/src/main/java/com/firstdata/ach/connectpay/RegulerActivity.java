...
public class RegulerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                callRegulerEnrollment(enrollmentRequest);
     ...
     */
    public void callRegulerEnrollment(EnrollmentRequest enrollmentRequest) {
        final EditText editTextName = new EditText(this);
        final LinearLayout linearLayout = new LinearLayout(this);

        firstApi.enrollReguler(enrollmentRequest).doOnSubscribe(new Action0() {
            @Override
            public void call() {
                progressDialog = ProgressDialog.show(RegulerActivity.this, "Processing Enrollment call", "Please Wait processing Enrollment Call", true, false);
            }
                        ...
                        new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if (userText != null && userText.trim().length() == 0) {
                                    Toast.makeText(RegulerActivity.this, "** Please enter a valid Auth Answer", Toast.LENGTH_SHORT).show();
                                    ...
                                    firstApi.callMicroValidate(baaRequest).doOnSubscribe(new Action0() {
                                        @Override
                                        public void call() {
                                            progressDialog = ProgressDialog.show(RegulerActivity.this, "Micro Validation is in process", "Please Wait processing micro validation call", true, false);
                                        }
                                    }).subscribe(new Observer<TokenResponse>() {
                                        @Override
                                        public void onCompleted() {
                                        ...
                                        public void onNext(TokenResponse tokenResponse) {
                                            progressDialog.dismiss();
                                            Log.d("Ok", "Enrollment Id -> " + tokenResponse.getEnrollmentId());
                                            callTransaction(tokenResponse.getEnrollmentId());
                                        }
                                    });
                                }
        ...
        alert.getButton(Dialog.BUTTON_POSITIVE).setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        String userText = editTextName.getText().toString();
                        if (userText != null && userText.trim().length() == 0) {
                            Toast.makeText(RegulerActivity.this, "** Please enter a valid Amount", Toast.LENGTH_SHORT).show();
                            ...
                            firstApi.createPrimaryTransaction(transactionRequestObj).doOnSubscribe(new Action0() {
                                @Override
                                public void call() {
                                    progressDialog = ProgressDialog.show(RegulerActivity.this, "Transaction is in process", "Please Wait processing transaction call", true, false);
                                }
    ...
    public void performRefund(final String enrollmentId, String transactionId, String amount) {
        ...
        firstApi.createSecondaryTransaction(transactionId, transactionRequestObj).doOnSubscribe(new Action0() {
            @Override
            public void call() {
                progressDialog = ProgressDialog.show(RegulerActivity.this, "Refund is in process", "Please Wait refund transaction call", true, false);
            }
        }).subscribe(new Observer<TransactionResponse>() {
            @Override
            public void onCompleted() {
